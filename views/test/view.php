                            ...
                            <li class="grid-item wow animate__fadeIn">
                                <div class="blog-post border-radius-5px bg-white box-shadow-medium">
                                    ...
                                    <div class="post-details padding-3-rem-lr padding-2-half-rem-tb">
                                        <a href="" class="alt-font text-small d-inline-block margin-10px-bottom"><?=$model->country?> </a>
                                        <a href="" class="alt-font font-weight-500 text-extra-medium text-extra-dark-gray margin-15px-bottom d-block"><?=$model->name;?></a>
