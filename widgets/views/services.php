...
<section class="services-two">
    <div class="services-two__left-bg float-bob-y"><img src="/images/backgrounds/services-v2-left-bg.png"
                                                        alt="" /></div>
    <div class="services-two__right-bg"><img src="/images/backgrounds/services-v2-right-bg.png" alt="" />
    </div>
    <div class="shape1 float-bob-y"><img src="/images/shapes/services-v2-shape1.png" alt="" /></div>
    <div class="shape2 float-bob-y"><img src="/images/shapes/services-v2-shape2.png" alt="" /></div>
    <div class="shape3 rotate-me"><img src="/images/shapes/services-v2-shape3.png" alt="" /></div>
    <div class="shape4 float-bob-y"><img src="/images/shapes/thm-shape1.png" alt="" /></div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 wow slideInRight" data-wow-delay="100ms" data-wow-duration="2500ms">
                    <div class="services-two__bottom-img float-bob-y">
                        <img src="/images/services/services-v2-img1.png" alt="" />
                    </div>
                </div>
            </div>
        </div>
